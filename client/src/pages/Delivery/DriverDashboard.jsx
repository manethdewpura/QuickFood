    ...
    const fetchCustomerLocations = async () => {
      ...
      for (const order of nearestOrders) {
        try {
          ...
          console.error(
            `Failed to fetch location name for order ${order._id}`,
            err
          );
  ...
  return (
    <div className="bg-gray-100 min-h-screen relative">
      ...
      <div className="absolute top-20 right-4">
        {deliveries.length === 0 ? (
          <button
            className={`px-6 py-3 rounded-md font-semibold shadow ${
              isAvailable
      ...
      <div className="container mx-auto px-4 py-8">
                ...
                >
                  <div className="text-gray-700 space-y-1">
                    ...
                    <p>
                      ...
                      {delivery.orderDetails.data.restaurant.address}
                    </p>
                    <p>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-black mb-4">
            Nearest Ready Orders
          </h2>
          {nearestOrders.length === 0 ? (
            <p className="text-gray-500 text-center">
              No ready orders nearby at the moment.
            </p>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {nearestOrders.map((order) => (
                ...
                >
                  ...
                  <div className="text-gray-700 space-y-1">
                    ...
                    <p>
                      <strong>Pickup:</strong> {order.restaurant.Address}
                    </p>
                    <p>
                      <strong>Customer Location:</strong>{" "}
                      {customerLocations[order._id] || "Fetching..."}
                    </p>
                    <p>
